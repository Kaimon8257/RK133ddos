...
# 🎛️ Telegram API token (7276405028:AAEwDCLCeCgtoyBPz59L2Id97XXH262aZjo)
TOKEN = '7276405028:AAEwDCLCeCgtoyBPz59L2Id97XXH262aZjo'
bot = telebot.TeleBot(TOKEN, threaded=False)

# 🛡️ List of authorized user IDs (replace with actual IDs)
AUTHORIZED_USERS = [6034827272, 709106377,7562199136]
